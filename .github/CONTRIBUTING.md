...
1. [Fork](https://github.com/qdm12/plex-to-jellyfin/fork) and clone the repository
...
1. Push to your fork and [submit a pull request](https://github.com/qdm12/plex-to-jellyfin/compare)
